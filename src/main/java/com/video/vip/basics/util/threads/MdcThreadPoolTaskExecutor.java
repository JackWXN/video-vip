package com.video.vip.basics.util.threads;
...
public class MdcThreadPoolTaskExecutor extends ThreadPoolTaskExecutor {
    ...
    private static final long serialVersionUID = 2416390522228322232L;
    ...
    public void execute(Runnable runnable) {
        ...
        log.debug("开始进行线程池的MDC传递：HEADER_NAME = {}",MDC.get(WebAppTraceFilter.HEADER_NAME));
