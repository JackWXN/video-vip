package com.video.vip.basics.util.valis;
...
public class FormValidationUtils {
    ...
    public final static boolean isUrl(String str) {
        return FormValidationUtils.match(str, "^http://([\\w-]+\\.)+[\\w-]+(/[\\w-./?%&=]*)?$");
    }
    ...
    public final static boolean isPwd(String str) {
        return FormValidationUtils.match(str, "^[a-zA-Z]\\w{6,12}$");
    }
    ...
    public final static boolean stringCheck(String str) {
        return FormValidationUtils.match(str, "^[a-zA-Z0-9\u4e00-\u9fa5-_]+$");
    }
    ...
    public final static boolean isEmail(String str) {
        return FormValidationUtils.match(str, "^\\w+([-+.]\\w+)*@\\w+([-.]\\w+)*\\.\\w+([-.]\\w+)*$");
    }
    ...
    public final static boolean isInteger(String str) {
        return FormValidationUtils.match(str, "^[+]?\\d+$");
    }
    ...
    public final static boolean isDigits(String str) {
        return FormValidationUtils.match(str, "^[0-9]*$");
    }
    ...
    public final static boolean isFloat(String str) {
        return FormValidationUtils.match(str, "^[-\\+]?\\d+(\\.\\d+)?$");
    }
    ...
    public final static boolean isPhone(String text){
        return FormValidationUtils.match(text, "^(\\d{3,4}-?)?\\d{7,9}$");
    }
    ...
    public final static boolean isMobile(String text){
        ...
        return FormValidationUtils.match(text, "^(((13[0-9]{1})|(15[0-9]{1})|(18[0-9]{1}))+\\d{8})$");
    }
    ...
    public final static boolean isIdCardNo(String text){
        return FormValidationUtils.match(text, "^(\\d{6})()?(\\d{4})(\\d{2})(\\d{2})(\\d{3})(\\w)$");
    }
    ...
    public final static boolean isZipCode(String text){
        return FormValidationUtils.match(text, "^[0-9]{6}$");
    }
    ...
    public final static boolean isRightfulString(String text){
        return FormValidationUtils.match(text, "^[A-Za-z0-9_-]+$");
    }
    ...
    public final static boolean isEnglish(String text){
        return FormValidationUtils.match(text, "^[A-Za-z]+$");
    }
    ...
    public final static boolean isChineseChar(String text){
        return FormValidationUtils.match(text, "^[\u0391-\uFFE5]+$");
    }
    ...
    public final static boolean isChinese(String text){
        return FormValidationUtils.match(text, "^[\u4e00-\u9fa5]+$");
    }
